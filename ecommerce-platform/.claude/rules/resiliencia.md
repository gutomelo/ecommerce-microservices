...
- Falhas de negócio esperadas (ex.: `StockUnavailableEvent`, `PaymentDeclinedEvent`) não são erros técnicos: são publicadas como eventos de compensação da própria Saga, não devem gerar retry nem ir para DLQ.
